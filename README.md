...
2. Clone the repo
   ```sh
   git clone https://github.com/AlexanderTaliaferro/BeeconApp.git
   ```
...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin AlexanderTaliaferro/BeeconApp
...
See the [open issues](https://github.com/AlexanderTaliaferro/BeeconApp/issues) for a full list of proposed features (and known issues).
...
Your Name - [@twitter_handle](https://twitter.com/twitter_handle) - theBeeconApp@gmail.com
